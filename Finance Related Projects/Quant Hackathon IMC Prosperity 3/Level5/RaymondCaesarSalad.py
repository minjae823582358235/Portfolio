            ...
            if product in state.market_trades:
                    for trade in state.market_trades[product]:
                        if trade.buyer == "Caesar":
                            ...
                            if trade.buyer == "Caesar" and position < limit:
                                result[product].append(Order(product, trade.price, buy_volume))
                            ...
                            if trade.buyer == "Caesar" and position > -limit:
                                result[product].append(Order(product, trade.price, -sell_volume))
...
prosperity3bt "Level5/James/RaymondCaesarSalad.py" 5 --no-out
