    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        def PriceAdjustment(product, mode=None):
            ...
            if product == "PICNIC_BASKET1":
                PB1_high = 36.13384788166159 + holdPremium  # TODO OPTIMISE
                PB1_mid = -3.7410876530328308 + holdPremium  # TODO OPTIMISE
                PB1_low = -3.74108765303283 + holdPremium  # TODO OPTIMISE
            ...
            if product == "DJEMBES":
                DJ_high = 30.286207347152168 + holdPremium  # TODO OPTIMISE
                DJ_mid = 14.293748988699083 + holdPremium  # TODO OPTIMISE
                DJ_low = -8.721536716161225 + holdPremium  # TODO OPTIMISE
                DJ_neg = -13.635043343560302 + holdPremium  # TODO OPTIMISE
                if mode == "buy":
                    factor = 1
                if mode == "sell":
                    factor = -1
