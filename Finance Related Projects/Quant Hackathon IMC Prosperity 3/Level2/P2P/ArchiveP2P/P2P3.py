# Premium does exist, more about subtracting the premium, then taking the prices.
import json
    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        for product in OrderbookDict:
            if product == "PICNIC_BASKET1":  # 6 croissants 3 jams 1 djembe
                ...
                zfactor1 = 1.5  # TODO: check if this is correct raymond is going to optimise the z entry point. 1,0.5 previous
                ##############################
                spread1 = (
                    vwap("PICNIC_BASKET1")
                    - vwap("PICNIC_BASKET2")
                ...
                if (
                    ...
                    cheapestVolume = abs(
                        state.order_depths[product].buy_orders[cheapestbid]
                    )
                    p1order.append(
                        Order(
                            "PICNIC_BASKET1",
