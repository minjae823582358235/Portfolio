...
kelpminvolume = 43.8978
kelpspreadedge = 3.7748
squidz = 1.0383
squidhistorylength = 115.8595
squidrsi = 33.3329
squidoverbought = 24.1539
squidoversold = 11.7239
squidrsitradesize = 21.5107
croissanthistorylength = 373.7013
croissantzthreshold = 1.0283
...
PARAMS = {
    ...
    SQUID_INK: {
        "z_threshold": squidz,         # The z-score threshold
        "history_length": squidhistorylength,      # Number of historical mid–prices to use
        # The RSI parameters are no longer used in our mean-reversion strategy
        "rsi_period": squidrsi,
        "rsi_overbought": squidoverbought,
        "rsi_oversold": squidoversold,
        "rsi_trade_size": squidrsitradesize,
    },
    CROISSANTS: {
...
s1Zscore = 2.3863  # TODO OPTIMISE!!!!!! 1 works pretty well
synth2Mean = 105.417
synth2Sigma = np.round(27.166 // np.sqrt(1000), decimals=5)
s2Zscore = 2.0182  # TODO OPTIMISE!!!!!!
diff_threshold_b1_b2 = 38.1439
