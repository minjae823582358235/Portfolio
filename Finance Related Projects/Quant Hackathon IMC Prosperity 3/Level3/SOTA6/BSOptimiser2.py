...
def run_strategy(**params):
    ...
    with open("Level3\SOTA6\Round3SOTA2.py", "r") as file:
        code = file.read()
    ...
    with open("Level3\SOTA6\Round3SOTA2.py", "w") as file:
        file.write(code)

    print("🚀 Executing simulation...")
    result = subprocess.run(
        ["prosperity3bt", "Level3\SOTA6\Round3SOTA2.py","3",'--no-out'],
        capture_output=True,
        text=True,
    )
...
df.to_csv("SOTAOptimised.csv", index=False)
