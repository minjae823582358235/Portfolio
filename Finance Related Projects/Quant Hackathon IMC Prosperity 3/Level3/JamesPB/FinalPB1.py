...
diff_threshold_b1_b2 = 176.8118 #176.8118
...
################################################################################################################
        ...
        if PICNIC_BASKET1 in state.order_depths:
            ...
            IWantThisMuch = 50 #Minimum Orders that need to be satistfied at every timestep. 
            ...
            if (
                ...
                diff_comp < self.diff_threshold_b1_b2
...
#         prosperity3bt "Level3/James/MeanJaymes/SendBasketPics.py" 3 --no-out
