...
SELL='sell'
maczscore = 1.2324
mactrade_size = 11.0412
macmean_window = 2.9672
macpatience = 104.2830
macdumpGreed = 1.2149
macstandardGreed = 3.8737
...
class Trader: ##from here
    ...
    def __init__(self) -> None:
        ...
        self.previousSunPrice=0
        self.previousSunDelta=0
        self.sunDeltatolerance=0.01
        self.sunMode=None
        self.mean_window=int(macmean_window)
        self.zscore = maczscore
        self.trade_size = int(mactrade_size)
